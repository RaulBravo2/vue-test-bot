...
const { createNewInvoice, updateInvoice } = useInvoices();
  ...
  <form @submit="onSubmit" class="space-y-12">
    <div class="space-y-5">
      ...
      <div class="mb-8 space-y-6 md:space-y-0 md:grid md:grid-cols-3 md:gap-10">
        ...
        <TextField id="dueDate" name="dueDate" label="Due Date" placeholder="Ex: MM/DD/YYYY" />
        <SelectField id="status" name="status" label="Status" placeholder="Select status">
          <SelectContent>
    ...
    <div class="space-y-5">
      ...
      <div class="mb-8 space-y-6 md:space-y-0 md:grid md:grid-cols-4 md:gap-6">
        ...
        <TextField id="email" name="email" label="Email" placeholder="Ex: email@domain.com" />
        <TextField id="phone" name="phone" label="Phone" placeholder="Ex: +1 202-555-0143" />
    ...
    <div class="space-y-5">
      ...
      <div class="mb-8 space-y-4 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-x-10 sm:gap-y-5">
        <TextField
          id="cardHolder"
          name="cardHolder"
        ...
        <TextField id="cardCVC" name="cardCVC" label="Card CVC" placeholder="Ex: 1324" />
      </div>
    </div>

    <div class="flex justify-end">
      <Button size="lg" type="submit" :disabled="isSubmitting">
        <Icon name="Save" :size="18" :strokeWidth="2" class="me-2" />
